...
| Preview a version change | `.\program.ps1 version 0.2.2 --check` | `bash program.sh version 0.2.2 --check` |
| Apply a version change | `.\program.ps1 version 0.2.2 --yes` | `bash program.sh version 0.2.2 --yes` |
...
Versions must use numeric semantic form such as `0.2.2`. A version write keeps
