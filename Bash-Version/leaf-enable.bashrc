...
# and start a new shell, or run: source /c/R/LeafOS0.2.3/Bash-Version/leaf-enable.bashrc
if [[ -f "/c/R/LeafOS0.2.3/Bash-Version/leaf.sh" ]]; then
    export LEAF_ROOT="/c/R/LeafOS0.2.3"
