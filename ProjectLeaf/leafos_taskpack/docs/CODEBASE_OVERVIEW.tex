...
\texttt{tests/} & 163 discovered Python contracts plus shell, native TUI, graph, provider, node, runtime, orchestration, and compatibility gates. \\
\bottomrule
\end{longtable}
...
\begin{itemize}
  ...
  \item The retained real four-minute generic resident profile passed with one completed resident-generated improvement and no blocked work.
...
\begin{itemize}
  \item Run and retain the real eight-minute and 64-minute WO-038 generic resident profiles before declaring the complete soak matrix passed.
