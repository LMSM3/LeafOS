...
[V] PASS: PowerShell AST parse, live Ficus evidence smoke check, and 23 focused tests
[P] LOCAL: repaired in the merged OneDrive snapshot; no staging, commit, or publication performed
