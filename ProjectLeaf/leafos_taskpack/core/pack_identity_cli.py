#!/usr/bin/env python3
"""CLI for applying deterministic visual identity to LeafOS model packs.

Visual identity is limited to flower, colour, symbol, and display_name.
...
def main() -> int:
    ...
    gen = subparsers.add_parser("generate", help="generate visual identity for a pack id")
    ...
    apply = subparsers.add_parser("apply", help="apply visual identity to model-pack files or registry entries")
