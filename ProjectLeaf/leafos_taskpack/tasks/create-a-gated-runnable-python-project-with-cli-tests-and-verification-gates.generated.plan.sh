...
# Task:       /c/R/LeafOS0.2.3/ProjectLeaf/leafos_taskpack/tasks/create-a-gated-runnable-python-project-with-cli-tests-and-verification-gates.md
...
run_step "/c/R/LeafOS0.2.3/ProjectLeaf/leafos_taskpack/bin/leafctl" doctor
run_step "/c/R/LeafOS0.2.3/ProjectLeaf/leafos_taskpack/tests/smoke.sh"
